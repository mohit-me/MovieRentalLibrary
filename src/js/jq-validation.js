...
$(document).ready(function(){
	...
	form.submit(function(){
		if(validateFirstName() & validateMobile() & validateDateofbirth() & validateLastName() & validatePassword() & validateZipcode() & validateAddress()  & validateCity() & validateState() & validateRePassword() & validateEmail() & validateUsername2())
		{
			return true;
		}
		else
...
/*Validation functions for each field*/	
	...
	function validateZipcode(){
		...
		else
		{
			...
			zipcodeMsg.text("Valid zipcode Code!");
			zipcodeFlag = false;
			return true;
		}
	}
