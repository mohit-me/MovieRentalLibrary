...
$(document).ready(function(){
	...
	form.submit(function(){
		if(validateFirstName() & validateMobile() & validateDateofbirth() & validateLastName() & validatePassword() & validateZipcode() & validateAddress()  & validateCity() & validateState() & validateRePassword() & validateEmail() & validateUsername2() & validatebcode2() &validateSalary() )
		{
			return true;
		}
		else
