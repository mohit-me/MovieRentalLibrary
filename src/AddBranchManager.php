...
?>
	...
	<h2>Branch Manager Registration</h2>
	...
	<article id="userform">
		...
		<form id="branchmanagerform" action="ConfirmManager.php" method="post">
			<p>
			...
			<p>
				...
				<input class="box" type="text" id="bcode" name="bcode" value="" size="12"/>
				<span id="bcodeMsg">What is the branch code?</span>
			</p>
			<p>
